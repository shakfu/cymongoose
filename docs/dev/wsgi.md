...
This document covers the internal architecture, design decisions, and known limitations of the `cymongoose.wsgi` module. For user-facing documentation see the [WSGI/ASGI Guide](../guide/wsgi.md).
