...
Living document tracking which parts of the mongoose C API are exposed in cymongoose and which are intentionally excluded. Update on each upstream upgrade.
